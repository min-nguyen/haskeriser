...
vertex_shade (CameraShader mview vport proj uni_M uni_MIT uni_Mshadow vary_uv vary_tri) 
            model iface nthvert = 
                let vert_uv     = (mapVec2 to_double ((model_uv model iface nthvert ) :: Vec2 Int) ) :: Vec2 Double
...
vertex_shade (DepthShader modelview viewport projection varying_tri) model iface nthvert = 
                let gl_vert = (embedVec3to4D $ model_vert model iface nthvert ) :: Vec4 Double
...
fragment_shade (DepthShader modelview viewport projection varying_tri) model bary_coords rgba =  
                                                ...
                                                in  debug ((varying_tri)) (color , (DepthShader modelview viewport projection varying_tri))                         
